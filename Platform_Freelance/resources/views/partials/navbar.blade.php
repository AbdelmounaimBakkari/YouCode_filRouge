<header class="sticky top-0 bg-gray-50 shadow-xl w-full flex flex-col md:flex-row justify-between items-center py-5 z-50">
    ...
    <nav>
        <livewire:search />
        <a href="{{ route('jobs.index')}}"class="mr-5 p-1 hover:text-white hover:font-semibold border rounded border-transparent hover:bg-gray-800 hover:border-blue-400">Services</a>
        @guest
        ...
        @else
            <a href="{{ route('conversation.index')}}"class="mr-5 p-1 hover:text-white hover:font-semibold border rounded border-transparent hover:bg-gray-800 hover:border-blue-400">Conversations</a>
