<header class="flex flex-col md:flex-row justify-between items-center py-5">
    <div>
        LOGO
    </div>
    ...
    <nav>
        ...
        @else
            ...
            <a href="{{ route('logout')}}"class="mr-5 hover:text-green-500" onclick="event.preventDefault();document.getElementById('logout_form').submit();">Se déconnecter</a>
