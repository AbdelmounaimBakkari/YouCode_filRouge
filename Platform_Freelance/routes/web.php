...
//     Route::get('/jobs/create', [JobController::class, 'create'])->middleware('freelancer')->name('jobs.create');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['client']], function () {
        Route::post('/submit/{job}', [ProposalController::class, 'store'])->middleware('proposal')->name('proposals.store');
    });
